!(function (e) {
    ...
    (a.m = e),
        ...
        (a.d = function (e, t, d) {
            a.o(e, t) ||
                Object.defineProperty(e, t, { enumerable: !0, get: d });
        }),
        (a.r = function (e) {
            ...
            if ("vr" === t)
                (s = parseInt(
                    document
                        ...
                        .getAttribute("key-code")
                )),
                    (r = document
                        .querySelector(`#${e.target.id}`)
                        .getAttribute("value"));
            else if (d.has(e.keyCode)) return;
            switch (s) {
                case 9:
                ...
                default:
                    (a = new CustomEvent("a-keyboard-update", {
                        detail: { code: s, value: r },
                    })),
                        document.dispatchEvent(a);
            }
            if ("vr" !== t) {
                const t =
                    document.querySelector(`#a-keyboard-${n}`) ||
                    document.querySelector(`#a-keyboard-${e.keyCode}`);
                t &&
    ...
    function (e, t, a) {
        ...
        e.exports = class {
            ...
            drawButton(e) {
                ...
                r.setAttribute(
                    "geometry",
                    `primitive: plane; width: ${a}; height: ${d};`
                ),
                    this.keyTexture && this.keyTexture.length > 0
                        ? r.setAttribute("material", `src: ${this.keyTexture}`)
                        : r.setAttribute(
                              "material",
                              "color: #4a4a4a; opacity: 0.9"
                          );
                const s = document.createElement("a-text");
                (s.id = `a-keyboard-${t.code}`),
                    s.setAttribute("key-code", t.code),
                    ...
                    s.setAttribute("width", this.fontSize),
                    s.setAttribute("height", this.fontSize),
                    s.setAttribute(
                        "geometry",
                        `primitive: plane; width: ${a}; height: ${d}`
                    ),
                    s.setAttribute(
                        "material",
                        `opacity: 0.0; transparent: true; color: ${this.highlightColor}`
                    ),
                    s.setAttribute("color", this.color),
                    s.setAttribute("font", this.font),
                    s.setAttribute("shader", "msdf"),
                    s.setAttribute("negate", "false"),
                    s.setAttribute("keyboard-button", !0),
                    s.setAttribute("class", "collidable"),
                    n.appendChild(r),
                    n.appendChild(s),
            ...
            drawKeyboard() {
                ...
                if (this.keyboardKeys) {
                    const e =
                            this.keyboardKeys[this.activeMode] ||
                            this.keyboardKeys.normal,
                        t = document.createElement("a-entity"),
                        a = 0.52,
                        d = 0.04 * e.length + 0.004 * (e.length - 1) + 0.04;
                    t.setAttribute(
                        "position",
                        `${a / 2 - 0.02} ${-d / 2 + 0.02} -0.01`
                    ),
                        t.setAttribute(
                            "geometry",
                            `primitive: plane; width: ${a}; height: ${d}`
                        ),
                        this.baseTexture && this.baseTexture.length > 0
                            ? t.setAttribute(
                                  "material",
                                  `src: ${this.baseTexture}`
                              )
                            : t.setAttribute(
                                  "material",
                                  "color: #4a4a4a; side: double; opacity: 0.7"
                              ),
                    ...
                    for (let t = 0; t < e.length; t++) {
                        ...
                        for (let e = 0; e < a.length; e++) {
                            const t = a[e],
                                r = this.parseKeyObjects(t);
                            if (!this.dismissable && "cancel" === t.type)
                                continue;
                            const s = r.size.split(" ")[0],
                                l = r.size.split(" ")[1];
                            this.drawButton({
                                key: r,
                                position: `${d + s / 2} ${n - l / 2} 0`,
                            }),
                                (d += parseFloat(s) + 0.004),
                                a.length === e + 1 && (n -= 0.044);
                        }
                    }
                }
            }
            toggleActiveMode(e) {
                e === this.activeMode
                    ? ((this.activeMode = "normal"), this.drawKeyboard())
