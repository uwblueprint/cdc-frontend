(function(modules) {
    ...
    AFRAME.registerComponent("super-keyboard", {
        ...
        init: function() {
            ...
            this.cursor.object3D.position.set(0, 0, .001);
        ...
        update: function(oldData) {
            ...
            if (this.data.label !== oldData.label || this.data.labelColor !== oldData.labelColor || this.data.width !== oldData.width) {
                ...
                this.label.object3D.position.set(0, .3 * w, -.02)
            }
            ...
            this.textInput.object3D.position.set(inputx, w / 4 - (this.inputRect.y + this.inputRect.h / 2) * w / 2 + kbdata.inputOffsetY * w, .002);
        ...
        tick: function(time) {
            ...
            for (var i = 0; i < keys.length; i++) {
                var k = keys[i];
                if (uv.x > k.x && uv.x < k.x + k.w && 1 - uv.y > k.y && 1 - uv.y < k.y + k.h) {
                    if (this.keyHover !== k) {
                        this.keyHover = k;
        ...
        initKeyColorPlane: function() {
            ...
            keyColorPlane.object3D.position.z = .001;
        ...
        setupHand: function() {
            ...
            if (this.data.hand) {
                ...
                this.hand = document.querySelector(["[cursor]", "[vive-controls]", "[tracked-controls]", "[gearvr-controls]", "[oculus-go-controls]", "[oculus-touch-controls]", "[windows-motion-controls]", "[hand-controls]", "[daydream-controls] [cursor] > [raycaster]"].join(","))
            }
            if (!this.hand) {
        ...
        updateCursorPosition: function() {
            ...
            if (this.data.align === "center") {
                pos = pos * ratio * fontFactor * .0011 / 2 + .02 * w
            } else if (this.data.align === "left") {
                pos = pos * ratio * fontFactor * .0011 + .02 * w;
                pos -= w / 2
            } else if (this.data.align === "right") {
                pos = -pos * ratio * fontFactor * .0011 - .02 * w;
                pos += w / 2
            }
            this.cursor.object3D.position.set(pos, posy, .001);
