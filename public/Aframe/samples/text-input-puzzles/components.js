  ...
  switch (code) {
    ...
    case 13:
      if (key == input.toLowerCase()) {
        document.querySelector("#input").setAttribute("value", "Congratulations!");
...
AFRAME.registerComponent("freeze", {
  init: function() {
    ...
    el.addEventListener("click", function(e) {
        ...
        document.querySelector("#input").setAttribute("value", "Answer here...");
        input = "";

        document.querySelector("#charlim").setAttribute("visible", true);
        document.querySelector("#charlim").setAttribute("value", "(" + key.length + " characters)");
