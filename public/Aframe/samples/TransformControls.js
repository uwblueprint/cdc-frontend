...
var TransformControls = function (camera, domElement) {
    ...
    this.pointerMove = function (pointer) {
        ...
        if (mode === "translate") {
            ...
            if (axis === "E") {
                ...
                rotationAngle =
                    offset.dot(_tempVector.cross(eye).normalize()) *
                    ROTATION_SPEED;
            }
            ...
            if (this.rotationSnap)
                rotationAngle =
                    Math.round(rotationAngle / this.rotationSnap) *
                    this.rotationSnap;
    ...
    function getPointer(event) {
        if (scope.domElement.ownerDocument.pointerLockElement) {
            ...
            var pointer = event.changedTouches
