        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            AFRAME.registerComponent("super-keyboard", {
                ...
                init: function () {
                    ...
                    document.addEventListener("keydown", function (ev) {
                        if (ev.key === "t") {
                            var ss = "";
                            var s =
                                "abcdefghijklmopqrstuvQWIEUTGASDLIGKBXACQWETL102394676457";
                            var l = Math.floor(Math.random() * 20);
                            for (var i = 0; i < l; i++)
                                ss += s[Math.floor(Math.random() * s.length)];
                            self.el.setAttribute("super-keyboard", {
                                value: ss,
                            });
                        }
                    });
                ...
                update: function (oldData) {
                    ...
                    if (
                        !oldData ||
                        this.defaultValue !== oldData.defaultValue
                    ) {
                        this.rawValue = this.data.value;
                        this.defaultValue = this.data.value;
                    ...
                    this.textInput.object3D.position.set(
                        inputx,
                        w / 4 -
                            ((this.inputRect.y + this.inputRect.h / 2) * w) /
                                2 +
                ...
                tick: function (time) {
                    ...
                    if (
                        this.prevCheckTime &&
                        time - this.prevCheckTime < this.data.interval
                    ) {
                        return;
                    }
                ...
                initKeyColorPlane: function () {
                    var keyColorPlane = (this.keyColorPlane = document.createElement(
                        "a-entity"
                    ));
                    ...
                    if (!this.hand) {
                        ...
                        if (!raycaster) {
                            ...
                            if (this.data.injectToRaycasterObjects) {
                                ...
                                if (
                                    objs.indexOf(".keyboardRaycastable") === -1
                                ) {
                ...
                filter: function (str) {
                    ...
                    for (var i = 0; i < this.data.filters.length; i++) {
                        switch (this.data.filters[i]) {
                            case "custom": {
                                if (this.userFilterFunc)
                                    str = this.userFilterFunc(str);
                                break;
                            }
                            case "allupper": {
                                str = str.toUpperCase();
                ...
                click: function (ev) {
                    ...
                    switch (this.keyHover.key) {
                        ...
                        case "Delete": {
                            this.rawValue = this.rawValue.substr(
                                0,
                        ...
                        case "Shift": {
                            ...
                            this.keyHover.el.setAttribute(
                                ...
                                "color",
                                this.shift
                                    ? this.data.keyHoverColor
                                    : this.data.keyBgColor
                            );
                            break;
                        }
                        case "Escape": {
                ...
                open: function () {
                    ...
                    if (this.hand && this.hand.ownRaycaster) {
                        this.hand.setAttribute("raycaster", {
                            showLine: true,
                            enabled: true,
                        });
                    }
                ...
                accept: function () {
                    this.el.emit("superkeyboardinput", {
                        value: this.data.value,
                    });
                ...
                blink: function () {
                    this.cursor.object3D.visible = !this.cursor.object3D
                        .visible;
                },
                ...
                updateCursorPosition: function () {
                    ...
                    var kbdata = KEYBOARDS[this.data.model];
                    var posy =
                        ((-this.inputRect.h / 2) * w) / 2.4 +
                        kbdata.inputOffsetY * w;
                    var ratio =
                        this.data.width /
                        this.textInput.components.text.data.wrapCount;
                    var pos = 0;
                    var fontFactor =
                        FontFactors[this.textInput.components.text.data.font];
                    if (fontFactor === undefined) {
                        fontFactor = 20;
                    }
                    for (var i = 0; i < this.data.value.length; i++) {
                        var char = findFontChar(
                            font.chars,
                            this.data.value.charCodeAt(i)
                        );
                        pos +=
                            char.width +
                            char.xadvance * (char.id === 32 ? 2 : 1);
                    }
                    if (this.data.align === "center") {
                        pos =
                            (pos * ratio * fontFactor * 0.0011) / 2.0 +
                            0.02 * w;
            ...
            module.exports = {
                basic: {
                    ...
                    layout: [
                        ...
                        { key: "q", x: 0.044, y: 0.377, w: 0.079, h: 0.152 },
                        { key: "w", x: 0.124, y: 0.377, w: 0.079, h: 0.152 },
                        { key: "e", x: 0.203, y: 0.377, w: 0.079, h: 0.152 },
                        { key: "r", x: 0.282, y: 0.377, w: 0.08, h: 0.152 },
                        { key: "t", x: 0.363, y: 0.377, w: 0.079, h: 0.152 },
                        { key: "y", x: 0.442, y: 0.377, w: 0.079, h: 0.152 },
                        { key: "u", x: 0.521, y: 0.377, w: 0.079, h: 0.152 },
                        { key: "i", x: 0.601, y: 0.377, w: 0.08, h: 0.152 },
                        { key: "o", x: 0.681, y: 0.377, w: 0.079, h: 0.152 },
                        { key: "p", x: 0.761, y: 0.377, w: 0.079, h: 0.152 },
                        { key: "l", x: 0.729, y: 0.53, w: 0.08, h: 0.154 },
                        { key: "a", x: 0.092, y: 0.53, w: 0.08, h: 0.154 },
                        { key: "s", x: 0.171, y: 0.53, w: 0.08, h: 0.154 },
                        { key: "d", x: 0.251, y: 0.53, w: 0.08, h: 0.154 },
                        { key: "f", x: 0.331, y: 0.53, w: 0.079, h: 0.154 },
                        { key: "g", x: 0.41, y: 0.53, w: 0.08, h: 0.154 },
                        { key: "h", x: 0.49, y: 0.53, w: 0.079, h: 0.154 },
                        { key: "j", x: 0.57, y: 0.53, w: 0.079, h: 0.154 },
                        { key: "k", x: 0.649, y: 0.53, w: 0.08, h: 0.154 },
                        { key: "z", x: 0.172, y: 0.684, w: 0.079, h: 0.154 },
                        { key: "x", x: 0.251, y: 0.684, w: 0.08, h: 0.154 },
                        { key: "c", x: 0.331, y: 0.684, w: 0.079, h: 0.154 },
                        { key: "v", x: 0.41, y: 0.684, w: 0.08, h: 0.154 },
                        { key: "b", x: 0.49, y: 0.684, w: 0.08, h: 0.154 },
                        { key: "n", x: 0.57, y: 0.684, w: 0.079, h: 0.154 },
                        { key: "m", x: 0.649, y: 0.684, w: 0.08, h: 0.154 },
                        { key: " ", x: 0.27, y: 0.838, w: 0.415, h: 0.126 },
                        {
                            key: "Shift",
                            x: 0.042,
                            y: 0.827,
                        ...
                        { key: "Insert", x: 0.058, y: 0, w: 0.881, h: 0.149 },
                    ],
                },
                numpad: {
                    wrapCount: 20,
                    ...
                    img: "sk-numpad.png",
                    layout: [
                        { key: "7", x: 0.313, y: 0.254, w: 0.088, h: 0.177 },
                        ...
                        { key: "0", x: 0.313, y: 0.785, w: 0.177, h: 0.161 },
                        { key: ".", x: 0.49, y: 0.785, w: 0.088, h: 0.161 },
                        {
                            key: "Escape",
                            x: 0.578,
                            y: 0.785,
