...
export default function RoomModal({
    ...
    return (
        <Dialog open={modalOpen} onClose={handleModalCloseClick}>
            ...
            <DialogContent>
                <div>
                    <Typography component="div" variant="h5">Room Name: </Typography>
                    <TextField
                        value={roomName}
                ...
                <div>
                    <Typography component="div" variant="h5">Room Friendly Name: </Typography>
                    <TextField
                        value={friendlyName}
                ...
                <div>
                    <Typography component="div" variant="h5">Room Description: </Typography>
                    <TextField
